...
class UploadPageHero extends React.Component {
  submitVideo = (event) => {
      ...
      comments: [
        {
          name: "Micheal Lyons",
          comment:
            "They BLEW the ROOF off at their last show, once everyone started figuring out they were going. This is still simply the greatest opening of concert I have EVER witnessed.",
    ...
    axios
      .post("https://roy-brainflix.herokuapp.com/videos", video)
      .then((result) => {
  ...
  postMainVideo = (id, sideVideo) => {
    axios
      .post(`https://roy-brainflix.herokuapp.com/videos/${id}`, {
        ...sideVideo,
        id: `${id}`,
      })
      .then((result) => {
      ...
      <>
        <form className="upload" onSubmit={this.submitVideo}>
          ...
          <div className="upload-input__buttons">
            <button className="upload-input__buttons__cancel-button1">
              CANCEL
            </button>
