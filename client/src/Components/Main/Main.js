...
class Main extends React.Component {
  ...
  getMainVideoData = (id) => {
    Axios.get(`https://roy-brainflix.herokuapp.com/videos/${id}`)
      .then((response) => {
        this.setState({
  ...
  componentDidUpdate = () => {
    if (
      this.state.mainVideoData.id !== this.props.match.params.id &&
  ...
  postComment = (id, comment) => {
    Axios.post(
      `https://roy-brainflix.herokuapp.com/videos/${id}/comments`,
      comment
    )
      .then((result) => {
      ...
      <div className="main">
        ...
        <div className="main__layout">
          ...
          <SideVideos
            ...
            mainVideoData={this.state.mainVideoData}
          />
        </div>
      </div>
    );
